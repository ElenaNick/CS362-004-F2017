...
int villageEffect(int currentPlayer, struct gameState *state, int handPos){
    ...
    //BUG ADDED IN LINE BELOW | ORIGINAL:  discardCard(handPos, currentPlayer, state, 0);  -->  BUG:  discardCard(currentPlayer, handPos, state, 0);
...
int mineEffect(struct gameState *state, int choice1, int choice2, int currentPlayer, int handPos){
    ...
    //BUG ADDED IN LINE BELOW | ORIGINAL:     if (choice2 > treasure_map || choice2 < curse) --> BUG: if (choice2 <= treasure_map && choice2 < curse)
...
int cardEffect(int card, int choice1, int choice2, int choice3, struct gameState *state, int handPos, int *bonus)
{
  ...
  switch( card ) 
    ...
    case mine:
        return mineEffect(state, choice1, choice2, currentPlayer, handPos);
